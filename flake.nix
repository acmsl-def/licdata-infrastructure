...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    acmsl-licdata-domain = {
      ...
      url = "github:acmsl-def/licdata-domain/0.0.22";
    };
    acmsl-licdata-events = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:acmsl-def/licdata-events/0.0.23";
    };
    acmsl-licdata-events-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:acmsl-def/licdata-events-infrastructure/0.0.14";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.2";
        sha256 = "1ixwdwgbynrqdkqia21wpykjjcksk8rnsgw3jh9xwc91v5ngryms";
        pname = "${org}-${repo}";
